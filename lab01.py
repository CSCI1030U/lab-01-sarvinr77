def main():
    ...
    interest_rate = 0.035
    investment = initial_investment #investment is a float and python can only concatenate strings
    investment += investment * interest_rate
    investment += investment * interest_rate
    investment += investment * interest_rate
    investment += investment * interest_rate
    investment += investment * interest_rate
    print('After 5 years, your investment will be worth ' + str(investment) + ' dollars.') #turned float into string
